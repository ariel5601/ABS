...
public class loansTakenTableController {

    @FXML
    private TableView<Loan> takenLoansTable;
    ...
    private Engine engine;
     public loansTakenTableController(){
...
//        takenLoansTable.getItems().addAll(loans);
        takenLoansTable.setVisible(true);
        takenLoansTable.setItems(loans);
//
    }
}
